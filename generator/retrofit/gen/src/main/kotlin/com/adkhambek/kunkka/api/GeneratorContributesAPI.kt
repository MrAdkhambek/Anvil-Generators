...
public class GeneratorContributesAPI : CodeGenerator {

    private companion object {
        private val contributesApiFqName = ContributesAPI::class.fqName
        val retrofitClassName = Retrofit::class.asClassName()
    }
        ...
        val content = FileSpec.buildFile(generatedPackage, moduleClassName) {
            addType(
                TypeSpec.objectBuilder(moduleClassName)
                    ...
                    .addFunction(
                        // @Provides @Reusable provideMyApi(retrofit: retrofit2.Retrofit): MyApi
                        FunSpec.builder("provide${apiClass.shortName}")
                            .addParameter("retrofit", retrofitClassName)
